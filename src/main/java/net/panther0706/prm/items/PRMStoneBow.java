...
public class PRMStoneBow extends BowItem {
    public static final int MAX_DRAW_DURATION = 71950;
    public static final float DEFAULT_RANGE = 1f;
    public static final float DAMAGE_MULT = 3.5f;
    public static final float INNACURACY_MULT = 1.1f;

    public PRMStoneBow(Item.Properties p_40660_) {
        super(p_40660_);
    }

...
public class PRMIronBow extends BowItem {
    public static final int MAX_DRAW_DURATION = 71950;
    public static final float DEFAULT_RANGE = 0f;
    public static final float DAMAGE_MULT = 5f;
    public static final float INNACURACY_MULT = 3f;

    public PRMIronBow(Properties p_40660_) {
        super(p_40660_);
    }
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!p_40668_.isClientSide) {
                        ...
                        abstractarrow.shootFromRotation(player, player.getXRot(), player.getYRot(), -DEFAULT_RANGE, f * DAMAGE_MULT, INNACURACY_MULT);
                        if (f == 1.0F) {
